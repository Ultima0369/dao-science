...
其中：
- **AB(t)**：觉知带宽（`1_first_principles/02_one_as_bandwidth.md`）——时刻 t 的可用认知容量
...
> 本文是 Project Dao.Science 心智模型系列（`2_models/`）的第四篇。前三篇为：`attention_model.md`（注意力动力学）、`100ms_model.md`（本能劫持与解离）、`neuroplasticity_loop.md`（神经重塑回路）、`dmn_self_model.md`（DMN 与自我模型）。
>
